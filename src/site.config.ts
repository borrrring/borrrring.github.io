...
export const theme: ThemeUserConfig = {
  ...
  footer: {
    ...
    social: [
      { icon: 'github', label: 'GitHub', href: 'https://github.com/borrrring' },
...
export const integ: IntegrationUserConfig = {
  ...
  links: {
    ...
    applyTip: [
      ...
      { name: 'Link', val: 'https://borrrring.github.io/' },
      { name: 'Avatar', val: 'https://borrrring.github.io/favicon_io/favicon.gif' }
    ],
